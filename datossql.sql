INSERT INTO `djangoschema`.`usuarioadminegresado_pais` (`id`, `paisNombre`) VALUES
(1, 'Australia'),
(2, 'Austria'),
(3, 'Azerbaiyán'),
(4, 'Anguilla'),
...
INSERT INTO `djangoschema`.`usuarioadminegresado_departamento` (`id`, `idPais_id`, `departamentoNombre`) VALUES
(1, 3, 'Azerbaijan'),
...
INSERT INTO `djangoschema`.`usuarioadministrador_intereses`(`titulo`, `description`) VALUES
('Trabajo', 'Actividades en las que implique ganancia monetaria'),
('Ocio', 'Recreación, actividades sociales con las que se espera conocer las viejas amistades y encontrar nuevas'),
('Investigación', 'Actividades realcionadas a la academia en el lado de investigación y apoyo a los semilleros y mejorar el intelecto'),
('Convenios', 'Todo tipo de actividades que se realiza para convenios relacionado a las carreras'),
('Academico', 'Actividades en las que impliquen mejorar a nivel de conocimiento y de titulación');

INSERT INTO `djangoschema`.`usuarioegresado_programaacademico` (`id`, `nombre`, `estado`) VALUES
(1, 'Licenciatura en Artes Visuales', 'activo'),
(2, 'Licenciatura en Bilingüismo con énfasis en Inglés', 'activo'),
(3, 'Licenciatura en Filosofía (Nocturno)', 'activo'),
(4, 'Licenciatura en Música', 'activo'),
(5, 'Ingeniería en Procesos Agroindustriales', 'activo'),
(6, 'Ingeniería en Procesos Sostenibles de las Maderas', 'activo'),
(7, 'Administración Ambiental', 'activo'),
(8, 'Administración del Turismo Sostenible (por ciclos propedéuticos)', 'activo'),
(9, 'Tecnología en Gestión del Turismo Sostenible (por ciclos propedéuticos)', 'activo'),
(10, 'Técnico Profesional en Procesos del Turismo Sostenible (por ciclos propedéuticos)', 'activo'),
(11, 'Licenciatura en Matemáticas y Física', 'activo'),
(12, 'Licenciatura en Comunicación e Informática Educativa', 'activo'),
(13, 'Licenciatura en Etnoeducación', 'activo'),
(14, 'Licenciatura en Literatura y Lengua Castellana', 'activo'),
(15, 'Licenciatura en Pedagogía Infantil', 'activo'),
(16, 'Ciencias del Deporte y la Recreación', 'activo'),
(17, 'Medicina', 'activo'),
(18, 'Medicina Veterinaria y Zootecnia', 'activo'),
(19, 'Tecnología en Atención Prehospitalaria', 'activo'),
(20, 'Ingeniería de Sistemas y Computación', 'activo'),
(21, 'Ingeniería Electrónica (Diurna)', 'activo'),
(22, 'Ingeniería Eléctrica', 'activo'),
(23, 'Ingeniería Física', 'activo'),
(24, 'Ingeniería Industrial', 'activo'),
(25, 'Ingeniería Mecánica', 'activo'),
(26, 'Administración Industrial', 'activo'),
(27, 'Ingeniería en Mecatrónica (por ciclos propedéuticos)', 'activo'),
(28, 'Química Industrial', 'activo'),
(29, 'Tecnología Eléctrica', 'activo'),
(30, 'Tecnología en Mecatrónica (por ciclos propedéuticos)', 'activo'),
(31, 'Tecnología Industrial', 'activo'),
(32, 'Tecnología Mecánica', 'activo'),
(33, 'Tecnología Química', 'activo'),
(34, 'Técnico Profesional en Mecatrónica (por ciclos propedéuticos)', 'activo'),
(35, 'Maestría en Ciencias Física', 'activo'),
(36, 'Maestría en Enseñanza de la Física', 'activo'),
(37, 'Maestría en Enseñanza de la Matemática (Extensión Cali - Valle del Cauca)', 'activo'),
(38, 'Maestría en Educación (Virtual)', 'activo'),
(39, 'Maestría en Infancia', 'activo'),
(40, 'Especialización en Gerencia en Prevención y Atención de Desastres', 'activo'),
(41, 'Especialización en Soldadura', 'activo'),
(42, 'Especialización Tecnológica en Ensayos no Destructivos para Inspección de Materiales', 'activo');




/*Consultar datos
SELECT * FROM djangoschema.usuarioadministrador_intereses;
SELECT * FROM `djangoschema`.`usuarioadminegresado_pais`;
SELECT * FROM `djangoschema`.`usuarioadminegresado_departamento`;*/
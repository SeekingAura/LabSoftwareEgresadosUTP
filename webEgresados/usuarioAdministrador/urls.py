...
from .views import solicitudes_view, aceptarSoli_view, rechazarSoli_view, crearNoticias_view, verNoticiasPropias_view, eliminarNoticia_view, editarNoticia_view, verNoticiasTodas_view, primerLogin_view, editarPerfil_view
...
urlpatterns = [
	...
	url(r'^perfil', editarPerfil_view, name="editarPerfil"),

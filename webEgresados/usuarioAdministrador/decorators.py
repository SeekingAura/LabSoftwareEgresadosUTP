...
#estos decoradores funcionan de que si se retorna True NO aplica el uso de la login_url y si retona False aplica dentro de la función de la función
...
#cuando exista super usuario se le dará uso
...
def redirectAdmin(index_url=None, raise_exception=False):
